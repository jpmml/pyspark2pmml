...
| 2.2.X | `1.3.X` | [1.3.12](https://github.com/jpmml/jpmml-sparkml/releases/download/1.3.12/jpmml-sparkml-executable-1.3.12.jar) |
| 2.3.X | `1.4.X` | [1.4.9](https://github.com/jpmml/jpmml-sparkml/releases/download/1.4.9/jpmml-sparkml-executable-1.4.9.jar) |
| 2.4.X | `master` | [1.5.2](https://github.com/jpmml/jpmml-sparkml/releases/download/1.5.2/jpmml-sparkml-executable-1.5.2.jar) |
